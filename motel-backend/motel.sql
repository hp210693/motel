...
CREATE TABLE room(
	...
	booking_date TIMESTAMP DEFAULT(NOW()) NULL,
	date_move_in TIMESTAMP DEFAULT(NOW()) NULL,
	date_move_out TIMESTAMP DEFAULT(NOW()) NULL,
...
INSERT INTO payment(account_id, room_id) VALUES
					(1,1),
					(3,1),
					(4,1),
					(5,2);
